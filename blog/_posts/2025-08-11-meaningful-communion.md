...
Not all writing has to be meaningful. This has been true since cuneiform was first used to inscribe a contract for a delivery of wheat four thousand years ago (and since [the first customer service complaint was written not long after that](https://en.wikipedia.org/wiki/Complaint_tablet_to_Ea-n%C4%81%E1%B9%A3ir)). Communication is often rote, boring, transactional, and formulaic. The business email, the todo list, the feature documentation - all of these seem to me unburdened by the lofty goals of interpersonal meaning. I don't feel troubled if an LLM wrote this kind of material, as I wasn't in search of a capital-r _Reading_ experience; I just want to get a job done.
