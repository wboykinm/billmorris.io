...
This is a question that could be answered with the information at hand, because there is _a lot_ of information at hand. [Strava](https://www.strava.com/routes/new) is excellent at planning routes. [Google Maps](https://maps.app.goo.gl/EhTrBNjFQXoAoXG26) is passable at telling me when places are opening and approximately how far away they are. [The National Weather Service](https://forecast.weather.gov/MapClick.php?lat=40.80788000000007&lon=-73.94541999999996) is very good at telling me when to seek shelter. 

![1](/shoals/assets/img/2024-07-15_1.png)

These services are all made possible with an ocean of data. In Google's POI case, that data is proprietary - and expensively-obtained - but nominally provided for free. In Strava's, it's cleverly based on crowdsourced user experience and open-source datasets. The NWS is righteously funded by you and me to offer its predictions for free and with any number of API endpoints. [My own employer](https://docs.mapbox.com/playground/) is famously good at offering the sort of weaving tools for geographic applications that could tie one service to the next, coming tantalizingly close to James Killick's ["Possible Magical Product" of a planning app](https://maphappenings.com/2024/06/20/trips/). I've [even taken small shots at this myself in the past](https://billmorris.io/shoals/2015/12/11/better-friendships-through-mapping-technology.html).
